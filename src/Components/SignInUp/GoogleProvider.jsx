...
const GoogleProvider = () => {
  ...
  return (
    <div onClick={handleGoogleSignIn} className="mx-auto flex h-[50px] w-[200px] items-center overflow-hidden rounded-full cursor-pointer shadow-md duration-300 hover:scale-95 hover:shadow">
